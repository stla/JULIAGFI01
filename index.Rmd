...
codechunk(file="type_Line.jl", size="63%")
```

```{r julia_orderpart, results='asis', echo=FALSE}
codechunk(file="function_orderPart.jl", size="63%")
```
...
codechunk(file="function_newLine.jl", size="63%")
```
...
codechunk(file="function_intersect.jl", size="57%")
```
