...
<pre><code class="r" style="font-size:63%"># order poly
...
<pre><code class="r" style="font-size:63%"># generates a new line with given intercept and slope
...
<pre><code class="r" style="font-size:57%"># returns the intersection of two lines given by (intercept, slope)
